...
?>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Create URL Type</h1>
									...
									<div class="card-body">
										<div class="row">
											<div class="col-12 col-lg-6">
												<div class="mb-3">
													<label class="form-label">Url Type Name</label>
													<input type="text" class="form-control" id="url_type_name" name="url_type_name">
											...
											<div class="text-center mt-3">
												<button class="btn btn-lg btn-primary" type="button" id="urlTypeBtn">Save</button>
			...
			<script>
			//create ajax call
			$("#urlTypeBtn").click(function (e) {			 
				$("#loader").css('display', 'block');
				e.preventDefault();
				var is_active = 0;
							
				var url_type_name = $("#url_type_name").val();
				is_active = $('#is_active:checked').val();//$("#is_active").val();
				
				if(typeof url_type_name !== 'undefined' && url_type_name !== ''){
										
					var urlTypeDetails = JSON.stringify({
						"url_type_name": url_type_name,
						"is_active": is_active
					});
					
					//console.log(urlTypeDetails);
					
					$form = $('#create_url_type_form');
					create_url_type_form($form);
					
					function create_url_type_form($form) {
						var formdata = new FormData($form[0]);
						formdata.append('form_name', 'create_url_type_form');
							...
							success: function (data) {						
								...
								if (data.message == "Successful") {
									...
									window.setTimeout(function() {
										window.location.href = "http://localhost/saprfc/urlType/view_url_type";	
									}, 2000);
