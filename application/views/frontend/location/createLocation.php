...
?>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Create Location</h1>
			...
			$("#loctionBtn").click(function (e) {			 
				...
				if(typeof loc_name !== 'undefined' && loc_name !== '' ){
					...
					function create_location_form($form) {
						var formdata = new FormData($form[0]);
						formdata.append('form_name', 'create_location_form');
							...
							success: function (data) {
								...
								if (data.message == "Successful") {
									...
									window.setTimeout(function() {
										window.location.href = "http://localhost/saprfc/location/view_location";	
									}, 2000);
