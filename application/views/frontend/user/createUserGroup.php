...
?>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Create User Group</h1>
									...
									<div class="card-body">
										<div class="row">
											...
											<div class="text-center mt-3">
												<button class="btn btn-lg btn-primary" type="button" id="groupBtn">Save</button>
			...
			$("#groupBtn").click(function (e) {			 
				...
				if(typeof grp_name !== 'undefined' && grp_name !== '' && typeof grp_desc !== 'undefined' && grp_desc !== ''){
					...
					$form = $('#create_user_group_form');
					create_user_group_form($form);
					
					function create_user_group_form($form) {
						var formdata = new FormData($form[0]);
						formdata.append('form_name', 'create_user_group_form');
							...
							success: function (data) {
								...
								if (data.message == "Successful") {
									...
									window.setTimeout(function() {
										window.location.href = "http://localhost/saprfc/user/view_user_group";	
									}, 2000);
